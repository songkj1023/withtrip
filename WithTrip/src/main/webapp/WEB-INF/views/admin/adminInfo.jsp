	...
	<c:if test="${ mNo == loginUser.member_no }">
        <span class="d-none d-lg-block" >
            ...
            <div class="collapse navbar-collapse"  id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="adminIfPage.ad" style="color: white;">계정 관리</a>
                </li>
                <li class="nav-item">
		            ...
		            <div class="row " style="padding: 10px;">
		                <div class="col-xl-12">
		                    <div class="card">
		                    	<br><br>
		                    	<c:if test="${loginUser.changeName == null}">
		                  			<img id="profile" class="img-fluid img-profile rounded-circle mb-2 w-25 mx-auto" src="${ contextPath }/resources/image2/profile.png" alt="" style="border-color: lightgrey; border-width :thin; border-style: solid">
		                    	</c:if>
		                    	<c:if test="${loginUser.changeName != null}">
	                            ...
	                            <div class="card-body">
	                                <div class="row" id="blockitems">
	                                    ...
	                                    <div class= "like">
	                                        ...
	                                        <form action="adminUpdate.ad" method="post" enctype="Multipart/form-data">
		                    ...
		                    <div class="card">
	                            <div class="card-body">
	                                ...
	                                <div class="row" id="blockitems">
	                                    ...
	                                    <p id= "infoTitle">이름</p>
	                                        <div class="area">
	                                      		<input type="text" class="updateText" name="userName" value="${ loginUser.userName }">
	                                      		<!-- span은 유효성 검사 문구 -->
		                            ...
		                            <div class="row" id="blockitems">
		                               ...
		                               <p id="infoTitle">주소</p>
		                                   <div class="area">
				                                ...
				                                <br><br><br><br>
				                    			<button type="submit" onclick="clickUpdate(userInfo)" class="infoBtn">개인 정보 수정</button>
		                                   </div>
		                               </div>
		                            </div>
...
// 			userInfo.submit();
	...
	$('#newPwd').keyup(function(){
		if(regPwd.test($('#newPwd').val())){
			...
			$('#pwdForm').html('영어 대소문자, 숫자, 특수문자를 포함하여 </br> 최소 8자 이상 입력해 주세요');
		}
	});
