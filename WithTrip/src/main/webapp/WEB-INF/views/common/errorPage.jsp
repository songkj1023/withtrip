    ...
    <g id="car-layers">
      ...
      <g id="Text">
        <text transform="translate(377.037 230.025)" class="st8 st10" font-size="21">
        	<a class="st8 st10" href="home.do">HOME</a>
        </text>
<!--         <text transform="translate(659.5 213.994)" class="st8 st10" font-size="15"> -->
        <text transform="translate(555 213.994)" class="st8 st10" font-size="12">
        ${ msg }
        </text>
      </g>
      <g id="ladders">
